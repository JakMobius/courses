...
#slide(background-image: none)[
  ...
  #place(horizon + center, dy: 1cm)[
    #cetz.canvas(length: 1cm, {
      ...
      cetz.draw.content((-spread - 5cm, 10), (rel: (5, 5)), [
        #let size = 5cm
      ...
      cetz.draw.content((spread, 10), (rel: (8, 5)), [
      ...
      cetz.draw.content((-code-displacement-x - 5, 14.5), (rel: (10, 1)))[
        #place(center + bottom, dy: -1cm)[
          *Сырой текст*
        ]
      ]

      cetz.draw.content((code-displacement-x - 5, 4.5), (rel: (10, 4)))[
        #place(center + bottom, dy: -1cm)[
          #box[
            #set align(left)
            - *Подсветка кода*;
